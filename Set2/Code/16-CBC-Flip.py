...
print("32 is the demo size")
print("Sometimes there is a msg before you can inject.")
pre_len = input("How many bytes are part of the prepended" +
                "msg? (Zero for none) \n")
pre_len = abs(int(pre_len))

print("There is no padding in the demo")
padding = input(
    "How much padding is required before the inject block?\n0 is acceptable\n")
...
print("There is {} bytes of pre msg and padding (should be a factor of blocksize)".format(
    pre_len + padding))
